...
# Environnement : Window Maker (OpenStep / NeXTSTEP)
...
#                   GNUstep/GWorkspace natif fonctionnel

echo "============================================================"
echo " Initialisation Workstation FreeBSD 15.1 (Édition OpenStep)"
echo "============================================================"
...
echo "-> Installation des composants Xorg, LightDM et NVIDIA..."
pkg install -y xorg dbus lightdm lightdm-gtk-greeter \
    nvidia-driver-470 nvidia-settings

echo "-> Installation de l'Environnement OpenStep (Window Maker & GNUstep)..."
pkg install -y windowmaker gnustep gworkspace wmclock geany
...
# ============================================================
# 9. Session graphique et variables globales
# ============================================================
echo "-> Configuration des variables globales..."
...
# ============================================================
# 10. Configurations spécifiques (Window Maker & GNUstep)
# ============================================================
echo "-> Configuration du démarrage OpenStep pour l'administrateur..."
WM_DIR="/home/administrateur/GNUstep/Library/WindowMaker"
mkdir -p "$WM_DIR"

# Création du script d'autostart avec le bon chargement GNUstep
cat > "$WM_DIR/autostart" << 'EOF'
#!/bin/sh
# Chargement des variables d'environnement GNUstep
. /usr/local/GNUstep/System/Library/Makefiles/GNUstep.sh

# Lancement du File Viewer NeXTSTEP
openapp GWorkspace &
EOF

chmod +x "$WM_DIR/autostart"
chown -R administrateur:administrateur /home/administrateur/GNUstep
...
echo "============================================================"
echo " Terminé ! Votre Workstation OpenStep est prête."
echo "============================================================"

...
# Version: 6.0 (Merged with Laptop optimizations, Dynamic User & NASA Theme)
# ==============================================================================
...
bsddialog --title "Video Configuration" \
          ...
          "1" "NVIDIA RTX / GTX (Official proprietary driver)" \
...
# NASA Theme (Preserved entirely from original script logic)
...
# ==============================================================================
# (Preserved exact Aquantia logic from original script)
...
rm -f "$MENU_OUT"
echo "✅ Installation complète ! Un redémarrage est nécessaire."